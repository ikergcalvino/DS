...
public class VendingMachineTest {
    ...
    public void testBuy() {
        ...
        maquina.insertDeposito(c1);
        maquina.insertDeposito(c1);
        maquina.insertDeposito(c1);
        maquina.insertDeposito(c2);
        maquina.insertDeposito(c2);
        maquina.insertDeposito(c2);
        maquina.insertDeposito(c5);
        maquina.insertDeposito(c5);
        maquina.insertDeposito(c5);
        maquina.insertDeposito(c10);
        maquina.insertDeposito(c10);
        maquina.insertDeposito(c10);
        maquina.insertDeposito(c20);
        maquina.insertDeposito(c20);
        maquina.insertDeposito(c20);
        maquina.insertDeposito(c50);
        maquina.insertDeposito(c50);
        maquina.insertDeposito(c50);
